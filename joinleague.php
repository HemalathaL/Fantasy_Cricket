   ...
   <body>
      ...
      <div class="content">
        <div class="container">
           ...
           <div class="row">
          <div class="col-md-10">
              <legend style="color: rgb(247,137,35);text-align:center;">League Matches with Joining Fees</legend>   <br>
         </div>
            <div class="col-md-10">  
            <?php
          ...
          if($conn)
          {
            ...
            if($result)
            {
                ...
                echo "<tr ><th>Id</th><th>Legue Name</th><th>MatchType</th><th>Time</th><th>Date</th><th>Capacity</th><th>Joining Fees</th><th>Join</th></tr>";
                ...
                while ($row = $result->fetch_assoc()) {
                   ...
                   // echo '<td><a href="join.php?value= . $row["id" ] .">Deduct Amount</a></td>';
                    echo "<td><a href='join.php?value=".$row['id']."'>Deduct</a></td>";
                    echo "</tr>";
                }
