   ...
   <body>
      ...
      <div class="content">
         <div class="form-style-5" style="padding:45px;">
          ...
          <fieldset>
         <legend><?php  session_start();  $userid=$_SESSION['userid']; echo "Wallet Balance for ". $_SESSION['userid'];?></legend><br><br>
         <?php
        //  session_start();
         ...
         ?>
         <input type="text" name="league" placeholder="Wallet Balance" value="<?php echo $userData['wallet_balance']; ?>"disabled>
